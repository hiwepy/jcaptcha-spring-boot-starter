...
**Spring Boot Starter for jcaptcha**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/jcaptcha-spring-boot-starter)](https://github.com/easy-4-java/jcaptcha-spring-boot-starter)
...
> **Artifact ID**：`jcaptcha-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**jcaptcha-spring-boot-starter** is a Spring Boot starter that integrates **jcaptcha** for applications using jcaptcha. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume jcaptcha capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using jcaptcha |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for jcaptcha |
| JDK | `17` |
| Coordinates | `io.github.easy4j:jcaptcha-spring-boot-starter:3.3.x.20260527-SNAPSHOT` |
| Config Prefix | `jcaptcha` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers jcaptcha beans automatically |
| Property Binding | ✅ Stable | Binds `jcaptcha.*` to `JCaptchaProperties` |
| `ImageCaptchaService` bean | ✅ Stable | Auto-registered via JCaptchaAutoConfiguration |
...
|---|---|---|
| `ImageCaptchaService` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `jcaptcha.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl jcaptcha-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `jcaptcha.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/jcaptcha-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/jcaptcha-spring-boot-starter)
